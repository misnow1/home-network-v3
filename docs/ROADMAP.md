...
| 3 | 31 | Kubernetes lab platform | **planned** | kubeadm + VLAN 9 workers; Cilium + Envoy Gateway; hybrid edge via proxy01 → MetalLB → Gateway API — [kubernetes-runbook.md](kubernetes-runbook.md), [adr/003-home-kubernetes.md](adr/003-home-kubernetes.md) |
